      ...
      <div className="grid py-4 gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="border border-offWhite p-4 rounded-xl text-center">
          <div className="text-violet-700">
            <FaBootstrap  className="mx-auto" size={100} />
          </div>
          <p className="text-dark font-bold text-2xl">Bootstrap</p>
        </div>
        <div className="border border-offWhite p-4 rounded-xl text-center">
          <div className="text-sky-600">
            <SiMui  className="mx-auto" size={100} />
          </div>
          <p className="text-dark font-bold text-2xl">Material UI</p>
        </div>
        <div className="border border-offWhite p-4 rounded-xl text-center">
        ...
        <div className="border border-offWhite p-4 rounded-xl text-center">
          <div className="text-orange-500">
            <SiPostman  className="mx-auto" size={100} />
          </div>
          <p className="text-dark font-bold text-2xl">Postman</p>
        </div>
      </div>
    </section>
  );
